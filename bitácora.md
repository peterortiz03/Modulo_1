...
* 08/04/2026: Tuvimos una clase sobre antenas donde, por ejemplo, medimos un dipolo que trajo el prodesor de 92 cm para 163 MHz. Aprendimos el uso y calibracion del NanoVNA, cuidando la impedancia de 50 ohms para proteger el equipo. Tambien tuvimos la primera interacción con la herramienta/apliación de diseño y simulación de antenas (ejemplo su ganancia) MMANA-GAL.
